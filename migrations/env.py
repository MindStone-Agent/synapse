...
# Inject our DB URL so alembic.ini doesn't need to hardcode anything
# beyond the script_location. Settings is the single source of truth.
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        ...
        context.configure(
            ...
            target_metadata=target_metadata,
            # batch mode is needed for SQLite ALTER TABLE workarounds.
